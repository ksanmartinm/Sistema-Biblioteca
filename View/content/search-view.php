            ...
            <div class="list-group">
                <div class="list-group-item">
                    <div class="row-picture">
                        <img class="circle" src="<?=APP_URL?>View/assets/book/book-default.png" alt="icon">
                    </div>
                    <div class="row-content">
                        <h4 class="list-group-item-heading">1 - Título completo del libro</h4>
                        <p class="list-group-item-text">
                            <strong>Autor: </strong>Nombre Autor del libro <br>
                            <a href="<?= APP_URL ?>book-info" class="btn btn-primary" title="Más información"><i class="zmdi zmdi-info"></i></a>
                            ...
                            <a href="<?= APP_URL ?>book-config" class="btn btn-primary" title="Gestionar libro"><i class="zmdi zmdi-wrench"></i></a>
                        </p>
                    </div>
                </div>
                ...
                <div class="list-group-item">
                    <div class="row-picture">
                        <img src="<?=APP_URL?>View/assets/book/book-cover.jpg" alt="icon">
                    </div>
                    <div class="row-content">
